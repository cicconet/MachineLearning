...
# such as IPython you can instead [of Session()] use the InteractiveSession class,
# and the Tensor.eval() and Operation.run() methods.
...
# exercise: visualize the kernels of the first layer